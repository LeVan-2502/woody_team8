                ...
                <div id="primary" class="content-area">
                    <div id="content" class="site-content" role="main">
                                                    ...
                                                    <div class="item-info">
                                                        <div class="content">
                                                            <div class="content-wrap">
                                                                <h1 class="">Nâng tầm <br>Không gian sống<br> Với phụ kiện nội thất đẳng cấp.</h1>
                                                                <a class="button-slider button-white mt-5" href="shop-grid-left.html">Mua ngay</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="content-image">
                                                        <img width="700" height="785" src="<?= BASE_URL ?>assets/ruper/media/slider/13.jpg" alt="Image Slider">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="item slick-slide">
                                                <div class="item-content">
                                                    <div class="item-info">
                                                        <div class="content">
                                                            <div class="content-wrap">
                                                                <h1 class="">Phong cách <br>Riêng của bạn<br> Không gian sống của bạn</h1>
                                                                <a class="button-slider button-white mt-5" href="shop-grid-left.html">Mua ngay</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="content-image">
                                                        <img width="700" height="785" src="<?= BASE_URL ?>assets/ruper/media/slider/14.jpg" alt="Image Slider">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="item slick-slide">
                                                <div class="item-content">
                                                    <div class="item-info">
                                                        <div class="content">
                                                            <div class="content-wrap">
                                                                <h1 class="">Sống đẹp <br>sống tiện nghi <br>Với phụ kiện nội thất hiện đại.</h1>
                                                                <a class="button-slider button-white mt-5" href="shop-grid-left.html">SHOP NOW</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="content-image">
                                                        <img width="700" height="785" src="<?= BASE_URL ?>assets/ruper/media/slider/15.jpg" alt="Image Slider">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <section class="section section-padding">
                            ...
                            <div class="section-container">
                                <div class="block-widget-wrap">
                                    <div class="block block-banners layout-6 banners-effect no-space">
                                        <div class="row">
                                            <div class="col-md-6 left">
                                                <div class="block-widget-banner layout-8">
                                                    <div class="bg-banner">
                                                        <div class="banner-wrapper banners">
                                                            <div class="banner-image">
                                                                <a href="shop-grid-left.html">
                                                                    <img width="959" height="837" src="<?= BASE_URL ?>assets/ruper/media/banner/banner-11.jpg" alt="Banner Image">
                                                                </a>
                                                            </div>
                                                            <div class="banner-wrapper-infor">
                                                                <div class="info">
                                                                    <div class="content">
                                                                        <div class="banner-image-subtitle">
                                                                            NEW COLLECTION
                                                                        </div>
                                                                        <a class="link-title" href="shop-grid-left.html">
                                                                            <h3 class="title-banner">Living Room</h3>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="block-widget-banner layout-8">
                                                            <div class="bg-banner">
                                                                <div class="banner-wrapper banners">
                                                                    <div class="banner-image">
                                                                        <a href="shop-grid-left.html">
                                                                            <img width="961" height="419" src="<?= BASE_URL ?>assets/ruper/media/banner/banner-12.jpg" alt="Banner Image">
                                                                        </a>
                                                                    </div>
                                                                    <div class="banner-wrapper-infor">
                                                                        <div class="info">
                                                                            <div class="content">
                                                                                ...
                                                                                <a class="link-title" href="shop-grid-left.html">
                                                                                    <h3 class="title-banner">Dining &amp; Kitchen</h3>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="block-widget-banner layout-8">
                                                            <div class="bg-banner">
                                                                <div class="banner-wrapper banners">
                                                                    <div class="banner-image">
                                                                        <a href="shop-grid-left.html">
                                                                            <img width="481" height="419" src="<?= BASE_URL ?>assets/ruper/media/banner/banner-13.jpg" alt="Banner Image">
                                                                        </a>
                                                                    </div>
                                                                    <div class="banner-wrapper-infor">
                                                                        <div class="info">
                                                                            <div class="content">
                                                                                ...
                                                                                <a class="link-title" href="shop-grid-left.html">
                                                                                    <h3 class="title-banner">Home Decor</h3>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="block-widget-banner layout-8">
                                                            <div class="bg-banner">
                                                                <div class="banner-wrapper banners">
                                                                    <div class="banner-image">
                                                                        <a href="shop-grid-left.html">
                                                                            <img width="481" height="419" src="<?= BASE_URL ?>assets/ruper/media/banner/banner-14.jpg" alt="Banner Image">
                                                                        </a>
                                                                    </div>
                                                                    <div class="banner-wrapper-infor">
                                                                        <div class="info">
                                                                            <div class="content">
                                                                                ...
                                                                                <a class="link-title" href="shop-grid-left.html">
                                                                                    <h3 class="title-banner">Interior lighting</h3>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                ...
                                <div class="block block-products">
                                    <div class="block-widget-wrap">
                                        <ul class="nav nav-tabs layout-2" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#top-rating" role="tab" aria-selected="false">Top Rating</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#best-selling" role="tab" aria-selected="false">Best Selling</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active show" data-toggle="tab" href="#featured" role="tab" aria-selected="true">Featured</a>
                                            </li>
                                        </ul>
                                                                    ...
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/6.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/6-2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                            ...
                                                            <div class="items">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/4.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/4-2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                            <div class="btn-add-to-cart" data-title="Add to cart">
                                                            ...
                                                            <div class="items">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/7.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/7-2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                            <div class="btn-add-to-cart" data-title="Add to cart">
                                                            ...
                                                            <div class="items">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/8.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/8-2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                            <div class="btn-add-to-cart" data-title="Add to cart">
                                                            ...
                                                            <div class="items">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/9.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/9-2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                            <div class="btn-add-to-cart" data-title="Add to cart">
                                                            ...
                                                            <div class="items">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/10.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/10-2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                            <div class="btn-add-to-cart" data-title="Add to cart">
                                                            ...
                                                            <div class="items">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/11.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/11-2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                            <div class="btn-add-to-cart" data-title="Add to cart">
                                                            ...
                                                            <div class="items">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="shop-details.html">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/12.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="<?= BASE_URL ?>assets/ruper/media/product/12-2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="product-button">
                                                                            <div class="btn-add-to-cart" data-title="Add to cart">
                                        ...
                                        <div class="block-widget-banner">
                                            <div class="bg-banner">
                                                <div class="banner-wrapper banners">
                                                    <div class="banner-image">
                                                        <a href="#">
                                                            <img width="961" height="452" src="<?= BASE_URL ?>assets/ruper/media/banner/newsletter-1.jpg" alt="Banner Image">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="block block-newsletter position-center">
                                        <div class="newsletter-wrap">
                                            <div class="sub-title">Join our mailing list!</div>
                                            <div class="title">Fancy $30* off your first order?</div>
                                            <div class="newsletter-content">
                                                <span class="your-email">
                                                    <input type="email" name="your-email" value="" size="40" aria-required="true" placeholder="Email address">
                                                </span>
                                                <span class="clearfix">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6">
                                    <div class="block block-menu m-b-20">
                                        ...
                                        <div class="block-content">
                                            <ul>
                                                <li>
                                                    <a href="page-contact.html">0243 566 6789</a>
                                                </li>
                                                <li>
                                                    <a href="page-contact.html">0243 678 8888</a>
                                                </li>
                                                <li>
                                                    <a href="page-contact.html">HR Fax: 0122 452 789</a>
                                                </li>
                                                <li>
                                                    <a href="page-contact.html">woodyshop2212@gamil.com</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="block block-menu">
                                        <h2 class="block-title">Cơ sở chính thức</h2>
                                        <div class="block-content">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="block block-menu">
                                        <h2 class="block-title">Chính sách và quy định</h2>
                                        <div class="block-content">
                                            <ul>
                                                <li>
                                                    <a href="page-about.html">Bảo mật</a>
                                                </li>
                                                <li>
                                                    <a href="page-about.html">Đổi trả hàng</a>
                                                </li>
                                                <li>
                                                    <a href="page-about.html">Giao hàng</a>
                                                </li>
                                                <li>
                                                    <a href="page-about.html">Điều khoản</a>
                                                </li>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="block block-newsletter">
                                        ...
                                        <div class="block-content">
                                            <div class="newsletter-text">Đăng kí để nhận thông tin mới nhất về chương trình của chúng tôi</div>
                                            <form action="" method="post" class="newsletter-form">
                                                <input type="email" name="your-email" value="" size="40" placeholder="Địa chỉ Email">
