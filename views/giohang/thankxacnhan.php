                                ...
                                <div class="shop-cart">
                                    <div class="row">
                                        <div class="thank-you-card">
                                            ...
                                            <h3 class="mt-3">Bạn vừa thanh toán thành công đơn hàng bằng VNPAY</h3>
                                            <p>Bấm vào đây để xác nhận.</p>
                                            <div class="btn-order">
                                                <a href="<?=BASE_URL .'?act=form-thank'?>" class="btn btn-secondary text-white">Xác nhận</a>
