                    ...
                    <div class="card">
                        <div class="card-header bg-primary">
                            <div class="row align-items-center">
                                <div class="col-11 ">
                                    <h class="card-title align-middlecard-title">Thêm mới bài viết</h6>
                                </div>
                                <div class="col-1">
                        ...
                        <div class="card-body">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form enctype="multipart/form-data" action="<?= BASE_URL_ADMIN ?>?act=them-baiviet" method="POST">
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <input name="ngay_dang" type="date" class="form-control" id="ngay_dang" placeholder="Ngày sinh">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="noi_dung" id="mytextarea"></textarea>
